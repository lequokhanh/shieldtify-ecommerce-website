...
const Card2 = () => {
    const { deliveryOptions, setDeliveryOptions, paymentMethod, setPaymentMethod } = useContext(CheckOutContext);
    return (
        <Box
        padding="25px 28px"
        borderRadius="12px"
        ...
        >
            ...
            >
                ...
                >
                    ...
                    style={{
                        backgroundColor: deliveryOptions==="Home" ? '#DEE1E6' : 'white',
                        alignItems:"center",
                        padding:"16px 20px",
                    ...
                    style={{
                        backgroundColor: deliveryOptions==="In-store" ? '#DEE1E6' : 'white',
                        alignItems:"center",
                        padding:"16px 20px",
                        border:"1px solid #9095A1",
                        borderRadius:"12px",
