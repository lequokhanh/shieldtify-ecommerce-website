        ...
        >
            ...
            <Flex flexDir="column">
                {discountedCode !== '' ? (
                    <CodeCard
                        code={{
                            discount: discountedCode,
                            description:
                                'Lorem ipsum dolor sit amet, consectet sed do eiusmod tempoaaaut la lorem ipasfkjasiofjasiofjioasfjioasfjioasfjioasjiofsjioasjasiofjasoifjasiofjasoifjasofjioasfjioasjiofasiojfasjiof',
                        }}
                    />
                ) : (
                    <Formik
                        ...
                        onSubmit={async (values, actions) => {
                            try {
                                await applyDiscountCode(voucherCode).then(
                                    (res) => {
                ...
                <Flex flexDir="column" mt="22px" gap="10px">
                    <HStack gap="8px">
