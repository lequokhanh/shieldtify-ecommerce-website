    ...
    return (
        <Flex flexDir="column" fontFamily="Inter" mt="100px" w="full" gap="70px" paddingX="81px">
            <VStack alignItems="flex-start" gap="15px">
                <Heading color="shieldtify.100" fontWeight="700" fontSize="2.5rem">
                    Pick Parts. Build Your PC.
                </Heading>
                <Text color="#545454" fontSize="1.5rem" fontWeight="300" noOfLines={2}>
                ...
                <Flex flexDir="column" alignItems={"flex-end"} gap="30px" w="full">
                    <VStack>
                        <HStack gap="70px">
                            <Text color="shieldtify.100" fontSize="2rem" fontWeight="700">
                                Total
                            </Text>
                            <Text color="#FF6262" fontSize="2rem" fontWeight="400">
                        ...
                        onClick={() => {
                            if(checkAllComponentsZero()) {
                                toast({
                                    title: "Error",
                                    description: "Please pick at least one component",
                                    status: "error",
                                    duration: 2000,
                                    isClosable: true,
                                });
